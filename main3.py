...
class Ui_MainWindow(QMainWindow):
    ...
    def setupUi(self):
       ...
       ## MainWindow.setFixedSize
        ...
        self.chechDateButton = QtWidgets.QPushButton(self.widget)
        self.chechDateButton.setObjectName("chechDateButton")
        self.gridLayout.addWidget(self.chechDateButton, 0, 4, 1, 3)
      ...
      #  self.statusbar.setObjectName("statusbar")
       # MainWindow.setStatusBar(self.statusbar)
        ...
        self.chechDateButton.clicked.connect(self.checkTest)
        self.setCentralWidget(self.centralwidget)
    def retranslateUi(self):
        _translate = QtCore.QCoreApplication.translate
       # MainWindow.setWindowTitle(_translate("MainWindow", "MainWindow"))
        self.loadIrisButton.setText(_translate("MainWindow", "Загрузить данные с рисом"))
        self.chechDateButton.setText(_translate("MainWindow", "Проверить тестовую выборку"))
